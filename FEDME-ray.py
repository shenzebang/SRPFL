...
from utils.test_utils import test_FEDME
from models.Update import LocalUpdateFEDME
...
if __name__ == '__main__':
    ...
    for iter in trange(args.epochs):
        ...
        test_flag = iter % args.test_freq == args.test_freq - 1 or iter >= args.epochs - 5
        ...
        locals = [LocalUpdateFEDME(args=args, dataset=dataset_train, idxs=dict_users_train[idx]) for idx in idxs_users]
        ...
        if test_flag:
            ...
            FT_acc_test, loss_test = test_FEDME(net_glob, args, dataset_test, dict_users_test,
    ...
    FT_save_file = f"./save/{args.dataset}-{args.shard_per_user}-{args.num_users}/FEDME-{args.description}-FT-{args.repeat_id}-{args.hyper_setting}.csv"
    ...
    global_save_file = f"./save/{args.dataset}-{args.shard_per_user}-{args.num_users}/FEDME-{args.description}-global-{args.repeat_id}-{args.hyper_setting}.csv"
