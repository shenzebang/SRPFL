...
do
    python FEDREP-ray.py\
        --dataset emnist --model mlp --num_classes 10 --epochs 150 --num_users 100 --gpu $(($i-1)) --seed $(($i * 10))\
        --shard_per_user 5 --test_freq 10 --frac 1 --repeat_id $i --description s1 --hyper_setting noniid-hyper\
...
do
    python FEDREP-ray.py\
        --dataset emnist --model mlp --num_classes 10 --epochs 150 --num_users 100 --gpu $(($i-1)) --seed $(($i * 10))\
        --shard_per_user 5 --test_freq 10 --frac 1 --repeat_id $i --description s1-flanp --hyper_setting noniid-hyper\
