...
do
    python FEDREP-ray.py\
        ...
        --shard_per_user 20 --test_freq 10 --frac 1 --repeat_id $i --description s1 --hyper_setting iid-hyper\
...
do
    python FEDREP-ray.py\
        --dataset cifar100 --model cnn --num_classes 100 --epochs 150 --num_users 100 --gpu $(($i-1)) --seed $(($i * 10))\
        --shard_per_user 20 --test_freq 10 --frac 1 --repeat_id $i --description s1-flanp --hyper_setting iid-hyper\
