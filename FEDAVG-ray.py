...
if __name__ == '__main__':
    ...
    if args.frac == 1:
        ...
        FT_save_file = f"./save/{args.dataset}-{args.shard_per_user}-{args.num_users}/FEDAVG-partial-{args.description}-FT-{args.repeat_id}-{args.hyper_setting}.csv"
    ...
    if args.frac == 1:
        ...
        global_save_file = f"./save/{args.dataset}-{args.shard_per_user}-{args.num_users}/FEDAVG-partial-{args.description}-global-{args.repeat_id}-{args.hyper_setting}.csv"
